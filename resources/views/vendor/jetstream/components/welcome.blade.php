...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ route('trello-reports') }}">Trello Reports</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Description of Trello Reports goes here.
            </div>

            <a href="{{ route('trello-reports') }}">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                        <div>View Trello Reports</div>
